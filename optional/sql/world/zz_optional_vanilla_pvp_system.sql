...
DELETE FROM `conditions` WHERE `Comment` = "Vanilla PvP Ranked Gear (IPP)"; 
...
-- Mark of honor change stack
UPDATE `item_template` SET `maxcount` = 1000 WHERE `entry` IN (19322,20558,20559,20560);
