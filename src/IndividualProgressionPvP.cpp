...
public:
    ...
    struct gobject_ipp_pvp_closedAI: GameObjectAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (player->IsGameMaster() || !sIndividualProgression->enabled || sIndividualProgression->isBotAccount(target) || sIndividualProgression->isExcludedAccount(target) || sIndividualProgression->hasPassedProgression(target, PROGRESSION_NAXX40))
                return false;
    ...
    struct npc_ipp_tbc_S1AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_NAXX40)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_2))
            {
                return true;
            }
            else 
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_NAXX40) && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_5) && sIndividualProgression->tbcArenaSeason == 1)
                return true;
            else
                return false;
        }
    ...
    struct npc_ipp_tbc_S2AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_TBC_TIER_2)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_3))
            {
                return true;
            }
            else 
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_NAXX40) && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_5) && sIndividualProgression->tbcArenaSeason == 2)
                return true;
            else
                return false;
        }
    ...
    struct npc_ipp_tbc_S3AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_TBC_TIER_3)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_4))
            {
                return true;
            }
            else 
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_NAXX40) && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_5) && sIndividualProgression->tbcArenaSeason == 3)
                return true;
            else
                return false;
        }
    ...
    struct npc_ipp_tbc_S4AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_TBC_TIER_4)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_5))
            {
                return true;
            }
            else 
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_NAXX40) && sIndividualProgression->isBeforeProgression(target, PROGRESSION_TBC_TIER_5) && sIndividualProgression->tbcArenaSeason == 4)
                return true;
            else
                return false;
        }
    ...
    struct npc_ipp_wotlk_S5AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_TBC_TIER_5)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_WOTLK_TIER_2))
            {
                return true;
            }
            else 
    ...
    struct npc_ipp_wotlk_S6AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_WOTLK_TIER_2)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_WOTLK_TIER_3))
            {
                return true;
            }
            else 
    ...
    struct npc_ipp_wotlk_S7AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_WOTLK_TIER_3)
                && sIndividualProgression->isBeforeProgression(target, PROGRESSION_WOTLK_TIER_4))
            {
                return true;
            }
            else 
...
public:
    ...
    struct npc_ipp_wotlk_S8AI: ScriptedAI
    {
        ...
        bool CanBeSeen(Player const* player) override
        {
            ...
            if (sIndividualProgression->hasPassedProgression(target, PROGRESSION_WOTLK_TIER_4))
            {
                return true;
            }
            else 
